...
export class ParentClass {
  ...
  parentClassPropertyFuncNestedType: (arg1: Array<ParentInterface>) => Array<ParentInterface>;

  parentClassMemberOne(argOne: number): boolean;
  parentClassMemberTwo(argOne: string): Array<boolean>;
  parentClassMemberFunc(argOne: (arg1: ParentInterface) => ParentInterfaceTwo): (arg1: ParentInterfaceTwo) => ParentInterfaceThree;
